//
//  MediationTestFramework.h
//  MediationTestFramework
//
...
//! Project version number for MediationTestFramework.
FOUNDATION_EXPORT double MediationTestFrameworkVersionNumber;
